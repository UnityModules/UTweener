//  Created by C.J. Kimberlin | Customized by Hamidreza Karamian
...
namespace UTweener
{
    ...
    public static class EasingFunction
    {
        ...
        public static float EaseInSineD(float start, float end, float value) => (end - start) * 0.5f * Mathf.PI * Mathf.Sin(0.5f * Mathf.PI * value);
